...
#'
#' @param reference_model A model object generated by \code{make_model()}.
#' @param analysis_model A model object generated by \code{make_model()}.
#' @param query A named list of query statements Names are estimand labels and values are strings containing estimand definitions. See `Examples` for correct format.

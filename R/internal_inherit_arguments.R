...
#'
#' @param model A \code{causal_model}. A model object generated by \code{\link[gbiqq]{make_model}}
#' @param reference_model A causal model as created by \code{\link[gbiqq]{make_model}}
#' @param analysis_model A causal model as created by \code{\link[gbiqq]{make_model}}
...
#' @param query A character string. An expression defining nodal types to interrogate \code{\link[gbiqq]{reveal_outcomes}}
...
#' @keywords internal
#'
gbiqqtools_internal_inherit_params <- function(model,
																							 reference_model,
																							 analysis_model,
																							 parameters,
																							 given,
